<x-layout>
  ...
  <div class="py-1 px-2 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
...
{{ $posts->links() }}
  ...
  <div class="my-4 py-4 px-4 mx-auto max-w-screen-xl lg:py-4 lg:p0-0">
  ...
  @forelse ($posts as $post)
        ...
        <a href="/posts" class="block text-blue-600 hover:underline text-sm">&laquo; Back to all posts</a>
        </div>
    @endforelse
                 </div>
            </div>
